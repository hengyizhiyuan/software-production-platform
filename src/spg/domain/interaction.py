...
class RepositoryAcquisitionState(StrEnum):
    ...
    # Source-compatible names for callers compiled against the first admission
    # slice. Their serialized values use the durable operation vocabulary above.
    READY_TO_ACQUIRE = "NOT_STARTED"
    REPOSITORY_ACQUISITION_RUNNING = "RUNNING"
    REPOSITORY_REALITY_BOUND = "READY"
    WAITING_FOR_REPOSITORY_AUTHORIZATION = "WAITING_FOR_AUTHORIZATION"
    ACQUISITION_RETRY_REQUIRED = "FAILED_RETRYABLE"
