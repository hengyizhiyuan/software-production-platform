...
class CodexSdkSemanticStepCapability:
    ...
    def _instruction(input: SemanticStepInput) -> str:
        ...
        return (
            ...
            "PRODUCE but the latest Work Reality has no current Production Plan. A RESOLVED "
            ...
            "do not substitute a design document for that outcome. Preserve the admitted "
            "runtime form and entrypoint in the production objective. "
