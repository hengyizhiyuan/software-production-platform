...
| [Reality-driven Plan Steering](../architecture/reality-driven-plan-steering-mvp-contract.md) | 1C/1D/1E/1F/1G are CLOSED / PASS. 1G separates long-lived Work admission from production admission. Real long-lived Dogfood continues; core closure remains pending. | MATERIAL MVP CORE PRODUCT CAPABILITY / IMPLEMENTED FOR MVP BEHAVIOR |
