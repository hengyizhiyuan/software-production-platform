...
## Consumer Project Relationship

For a Consumer Project such as 易决, the current direct integration is a **Reference / Transitional Integration**. The long-term direction is **Platform-mediated Integration**.
