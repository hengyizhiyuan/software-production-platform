...
export const CORE_WORKSPACE_SURFACES: WorkspaceFunction[] = [
  "reality",
  "agenda",
  "production",
  "actions",
...
export function visibleWorkspaceFunctions(_scene: Scene): WorkspaceFunction[] {
  return [...CORE_WORKSPACE_SURFACES];
}
...
export function workspaceMode(focused: WorkspaceFunction | null): WorkspaceMode {
  ...
  return `FOCUS_${CORE_WORKSPACE_SURFACES.indexOf(focused) + 1}` as WorkspaceMode;
}
 ...
 */
export function workspacePlacements(_visible: WorkspaceFunction[], focused: WorkspaceFunction | null): Record<WorkspaceFunction, SurfacePlacement | undefined> {
